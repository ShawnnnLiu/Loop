...
```
Read docs/implementation-plans/loop-grounding-rag/README.md, then
docs/implementation-plans/loop-grounding-rag/SPLITS.md (Split 1), then
docs/implementation-plans/loop-grounding-rag/01-corpus-and-contracts.md,
...
```
Read docs/implementation-plans/loop-grounding-rag/README.md, then
docs/implementation-plans/loop-grounding-rag/SPLITS.md (Split 2), then
docs/implementation-plans/loop-grounding-rag/02-retrieval-pipeline.md
...
```
Read docs/implementation-plans/loop-grounding-rag/README.md, then
docs/implementation-plans/loop-grounding-rag/SPLITS.md (Split 3), then
docs/implementation-plans/loop-grounding-rag/02-retrieval-pipeline.md
...
```
Read docs/implementation-plans/loop-grounding-rag/README.md, then
docs/implementation-plans/loop-grounding-rag/SPLITS.md (Split 4), then
docs/implementation-plans/loop-grounding-rag/03-grounding-integration.md,
...
```
Read docs/implementation-plans/loop-grounding-rag/README.md, then
docs/implementation-plans/loop-grounding-rag/SPLITS.md (Split 5), then
docs/implementation-plans/loop-grounding-rag/04-evaluation-and-writeup.md,
