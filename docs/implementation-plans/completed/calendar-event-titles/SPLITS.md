...
- **Branch:** `calendar-event-titles`, created from `main` once this plan
  folder has merged. If `docs/implementation-plans/completed/calendar-event-titles/`
...
```
Read docs/implementation-plans/completed/calendar-event-titles/00-overview.md and
