...
- Full gates both sides; `graphify update .`; flip
  `docs/implementation-plans/completed/ux-quality-pass/README.md` status to
...
> Read `docs/implementation-plans/completed/ux-quality-pass/HANDOFF.md` first — A/B/C
